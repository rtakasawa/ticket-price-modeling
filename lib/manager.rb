...
sales_calculation = SalesCalculation.new(sales_tickets)
output_format = OutputFormat.new

# サマリー
output_format.format_total_summary(sales_calculation.total_summary)
# 作品別売上
output_format.format_title_summary(sales_calculation.title_summary)
# 料金タイプ別売上
output_format.format_user_summary(sales_calculation.user_summary)
